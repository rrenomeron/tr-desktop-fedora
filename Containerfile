...
COPY --from=ghcr.io/ublue-os/akmods:coreos-stable-43-x86_64 / /oci/akmods
...
FROM ghcr.io/ublue-os/silverblue-main:gts@sha256:811246ee12b5a322a6c7c3a5de32ecf60bd1f42677b7e7fb484dbbb1fcc9978e
